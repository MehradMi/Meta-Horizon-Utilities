...
```shell
# Toggle everything
python debug_toggle.py <directory>

# Comment only specific tags
python debug_toggle.py <directory> --mode comment --only keep,production

# Uncomment everything except certain tags
python debug_toggle.py <directory> --mode uncomment --except temp

# Single file
python debug_toggle.py game.ts --only performance
